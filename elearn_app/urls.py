...
urlpatterns = [
    ...
    path("courses/", login_required(views.CourseList.as_view()), name="courses"),
    path("courses/create", login_required(views.CourseCreate.as_view()), name="courses.create"),
    path("courses/<int:pk>", login_required(views.CourseDetail.as_view()), name="courses.show"),
    path("courses/<int:pk>/destroy", login_required(views.CourseDelete.as_view()), name="courses.destroy"),
    ...
    # URLs for feedbacks
    path("feedback/<int:courseid>/", login_required(views.FeedbackCreate.as_view()), name="feedback.store"),
